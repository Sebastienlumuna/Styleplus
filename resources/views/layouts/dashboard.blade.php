...
<head>
    ...
    <title>@yield('title', 'Dashboard') - Boutique fille de sarah</title>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <a href="{{ route('home') }}" class="sidebar-brand">
                ...
                <span class="brand-text">Boutique fille de sarah</span>
            </a>
        </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <small class="text-muted">
                        © {{ date('Y') }} Boutique fille de sarah. Tous droits réservés.
                    </small>
                </div>
                <div>
                    <small class="text-muted">
